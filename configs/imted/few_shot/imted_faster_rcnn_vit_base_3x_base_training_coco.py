...
pretrained = '../pretrain/mae_pretrain_vit_base_full.pth'
pretrained = '../pretrain/mae_pretrained_vit_base_1600e.pth'
...
data = dict(
    ...
    train=dict(
        ...
        classes = classes, 
        ann_file='annotations/base_train/train_new.json',
        img_prefix='images/all/'),
    val=dict(
        classes = classes, 
        ann_file='annotations/base_train/5k_new.json',
        img_prefix='images/all/'),
    test=dict(
        classes = classes, 
        ann_file='annotations/base_train/5k_new.json',
